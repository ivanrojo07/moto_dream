...
var UsuarioProvider = /** @class */ (function () {
    ...
    UsuarioProvider.prototype.getToken = function (usuario) {
        var json = JSON.stringify(usuario);
        var params = json;
        console.log(params);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__providers_usuario_usuario__ = __webpack_require__(156);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
        ...
        this._usuarioService.login(this.usuario).subscribe(function (result) {
            if (!result) {
                ...
                if (result.failed) {
                    ...
                    _this._usuarioService.getToken(result).subscribe(function (res) {
                    }, function (err) {
                    });
                    console.log(result);
